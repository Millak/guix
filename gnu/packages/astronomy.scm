...
(define-public python-colossus
  ...
  (let ((commit "6a9888889e72566bdc909514d395f60ae7a1bede")
        (revision "0"))
    (package
      (name "python-colossus")
      (version (git-version "1.3.15" revision commit))
      (source
       (origin
         (method git-fetch)
         (uri (git-reference
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "153hw5xfi7fssy3jx0z46ha2flp09czx5769zg3g2ph859jpf98p"))))
      (build-system pyproject-build-system)
      (arguments
       (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1jpd8w0wbd6y2j2727mhbr1wspnbm3dqn17ic2gzizk13y9idz1k"))))
    (build-system pyproject-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1bcr22gyjpr8blm83p5ycknvdvnlqnayprcz7cspadkww9hhz00r"))))
    (build-system pyproject-build-system)
    (arguments
