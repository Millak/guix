...
(define-module (gnu packages window-management)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256 (base32 "0lm8ihg0mi72kli0swa7mzn20b9bsf0qpvpv58swybs1qj4hwwhl"))))
    (build-system meson-build-system)
    (native-inputs (list pkg-config scdoc
                         ;; for wayland-scanner
                         wayland))
    (inputs (list wayland wlroots-0.20 libxkbcommon))
...
(define-public hyprland
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "02z3zwp2ixh2xsxjy7i1m31jh1nakyfaizbgchx60bm4wr3xmk8h"))))
    (build-system cmake-build-system)
    (arguments
...
using CSS, it is easy to customize and provides all the flexibility you need.")
      (license license:expat))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1yw14jy952sp6yq13ccnn6wma7qplf737d1zydk534m0sy5zfh82"))))
    (build-system meson-build-system)
...
(define-public cagebreak
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xdbs55mnycii39lcyxax6hkpbp3aiwic27b7y82rfnqdd4syxij"))))
    (build-system meson-build-system)
    (arguments
     (list
    ...
    (native-inputs (list pkg-config scdoc))
    (inputs (list libevdev pango wlroots-0.20))
...
(define-public labwc
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08aa1603kdjf4cdbjxahlywa7d2x316bsl259znrcdqxkcwhvcnl"))))
    (build-system meson-build-system)
    (native-inputs
