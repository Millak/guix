...
(define-public qemu-for-aflplusplus
  (let ((base qemu-minimal)
        (commit "d4a7b70af4d387a9a57c743ef1827b2347aa7d7c")
        (revision "3"))
    (hidden-package
     (package
       (inherit base)
       ...
       (source
        (origin
          ...
          (file-name (git-file-name name version))
          (sha256
           (base32 "1h1z1zfrcv2mns4vkfb4hmjlcci1m4ba51p5hml5pzmvn9dmfkj7"))))
       (arguments
  ...
  (let* ((machine (match (or (%current-target-system)
    ...
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "14wnydymr19qwyc1dq1klm0ify37rvv69msh86hcw588g4gh3hbq"))))
      (build-system gnu-build-system)
      (arguments
