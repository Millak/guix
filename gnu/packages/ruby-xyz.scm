...
(define-public ruby-thor
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1mfc7x81zvi56as2r5zlbp9qrn71pdxlsnry06zi8rfykb4qnwfm"))))
    (build-system ruby-build-system)
    (arguments
     (list
      #:phases
...
(define-public ruby-neatjson
  (package
    ...
    (synopsis "JSON strings from Ruby objects generator")
    (description
     "This package implements a functionality of pretty-print JSON with more
formatting options than the built-in @code{JSON.pretty_generate}, such as
keeping arrays and objects on a single line when possible, aligning or sorting
object keys, customizing numeric representation, and more.")
...
(define-public ruby-cuke-modeler
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0g03zz8p4xn8k2yfq0421qn0wfxr459v1fh1xalhgqy6ri93lnbs"))))
    (build-system ruby-build-system)
    (arguments
               ...
               (add-after 'unpack 'relax-requirements
                 (lambda _
                   (substitute* "rakefiles/testing_tasks.rb"
                     ...
                     (("'bundle', 'exec', ") "")
                     (("current_version = .*") "")
                     (("unsupported_versions\\.include\\?\\(current_version\\)") "false")
                     (("bundle exec ") ""))
                   (substitute* "Rakefile"
                   ...
                   (substitute* "environments/rspec_env.rb"
                     (("require 'simplecov'") ""))
                   (substitute* "environments/cucumber_env.rb"
                     (("require 'simplecov'") "")))))))
    (native-inputs
...
(define-public ruby-gem-hadar
  (package
    ...
    (propagated-inputs
     (list git-minimal ruby-tins ruby-yard))
...
(define-public ruby-excon
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ym2jaj9cyn4kwv0936z6fvxh1j6jfw0j7dln1gy8xnsszv0p4w8"))))
    (build-system ruby-build-system)
    (arguments
     (list
      #:phases
      #~(modify-phases %standard-phases
          ...
          (add-before 'check 'disable-incompatible-tests
            (lambda _
              ;; Tests require networking
              (delete-file "spec/requests/resolv_resolver_spec.rb")
              (delete-file "spec/requests/dns_timeout_spec.rb"))))))
    (native-inputs
     (list
      ruby-activesupport
      ruby-eventmachine
