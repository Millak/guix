...
(define-public go-github-com-azure-azure-sdk-for-go-sdk-security-keyvault-internal
  (package
    ...
    (arguments
     (list
      #:import-path "github.com/Azure/azure-sdk-for-go/sdk/security/keyvault/internal"
      #:unpack-path "github.com/Azure/azure-sdk-for-go"))
    (native-inputs
     (list go-github-com-stretchr-testify))
    (propagated-inputs
  ...
  (package
    ...
    (propagated-inputs
     (list go-github-com-grpc-ecosystem-go-grpc-middleware-v2
           ...
           go-google-golang-org-grpc))
    (home-page "https://github.com/grpc-ecosystem/go-grpc-middleware")
    (synopsis "Prometheus monitoring for gRPC Go servers and clients")
    (description
...
(define-public go-go-opentelemetry-io-otel-exporters-otlp-otlpmetric-otlpmetricgrpc
  (package
    (name "go-go-opentelemetry-io-otel-exporters-otlp-otlpmetric-otlpmetricgrpc")
    (version "1.33.0")
    (source
     (origin
       (method git-fetch)
            ...
            (define (delete-all-but directory . preserve)
              (with-directory-excursion directory
                (let* ((pred (negate (cut member <>
                       ...
                       (items (scandir "." pred)))
                  (for-each (cut delete-file-recursively <>) items))))
            (delete-all-but "exporters/otlp/otlpmetric" "otlpmetricgrpc")
...
(define-public go-gomodules-xyz-jsonpatch-v2
  (package
    ...
    (native-inputs
     (list go-github-com-stretchr-testify))
    (propagated-inputs
     (list go-github-com-evanphx-json-patch
           go-github-com-pkg-errors))
    (home-page "https://github.com/gomodules/jsonpatch")
    (synopsis "JSON Patch (RFC 6902) and target document generation")
    (description
     "This package provides functionality for generating JSON Patch documents
and for applying JSON Patch operations to JSON documents per RFC 6902.  It's
an alternative fork of @url{https://github.com/mattbaird/jsonpatch}.")
    (license license:asl2.0)))
