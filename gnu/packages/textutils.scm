...
;; XXX: Deprecated on <2026-07-24>.
(define-deprecated/public-alias onigmo (@ (gnu packages regex) onigmo))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1b1g6rn46x8ky4arnq56jdhxlb1v3mnirdn7l29dhdwsd9arp33r"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1s21w1757x010f56qn2ykrabxp2sljx69zpyrk560yq5inxx73vv"))))
    (build-system go-build-system)
    (arguments
     (list
      #:install-source? #f
