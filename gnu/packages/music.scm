  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1044y8si6lan7m9cyg0s7k53x1wmldjj6c0nwq1zdgs19xcsd703"))))
    (build-system pyproject-build-system)
    ...
    (source
     (origin
       ...
       (uri (string-append "http://lilypond.org/download/sources/"
                           ...
                           "lilypond-" version ".tar.gz"))
       (sha256
        (base32 "14ykhp9bzw9hhzcy215dj3ylfil3hxnyy2wqy0xdniz23r2sr0db"))))))
...
(define-public synthv1
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "10bx0hs250kgvlblrqhxsr1pjfrcrfzry7n4plfvpm7gbxibb1bs"))))
    (build-system cmake-build-system)
    (arguments
     `(#:tests? #f))                    ; there are no tests
    (inputs
...
(define-public drumkv1
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1h9qna9p2h8gxp79fdd0kzmds3lzsj3w1fn7r02jgbw270xr6cwd"))))
    (build-system cmake-build-system)
    (arguments
     `(#:tests? #f))                    ; there are no tests
    (inputs
...
(define-public padthv1
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0qj1163n71lhpibafhdkf664lyfplcq669qc791aawqdbwivbsha"))))
    (build-system cmake-build-system)
    (arguments
     `(#:tests? #f))                    ; there are no tests
    (inputs
