  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1p1mbr95yv95jdi02zrkn4vg8pz3vwrg51jkafrljq9przmn2wxj"))))
    (build-system gnu-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1jisbl0a1x91gpn8j4yh55ln82l7gnp6rj8f0s6nvv02pil0484r"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "06llbzs5iza4qsj05znyn0h2nqrz7fkqdd9iyh2y8a45zb8nd6fw"))))
    (build-system meson-build-system)
    (native-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1gc31m7kh11zp5pwy4m3aj1nzsgwy7vhdl3lr0gi6j6qdfwjybfh"))))
    (build-system gnu-build-system)
    (native-inputs
     (list xfce4-dev-tools))
    (inputs
