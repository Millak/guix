...
(define-public linux-libre-5.17-version "5.17.2")
...
(define-public linux-libre-5.16-version "5.16.19")
...
(define-public linux-libre-5.16-pristine-source
  (let ((version linux-libre-5.16-version)
        (hash (base32 "0zlvsnbmcx4l8a5cqciwaabm1267q5zn4ah3gfhxi0jvigx2qvfs")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.16)))
...
(define-public linux-libre-5.15-version "5.15.33")
...
(define-public linux-libre-5.15-pristine-source
  (let ((version linux-libre-5.15-version)
        (hash (base32 "1i590npi00w5d1znmamkm3sb293k5k4xd37miwnvz7hg17k1f2n3")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.15)))

(define-public linux-libre-5.10-version "5.10.110")
...
(define-public linux-libre-5.10-pristine-source
  (let ((version linux-libre-5.10-version)
        (hash (base32 "14sn906f1bd87ngq1g2hx458v42d4nlzr36ba4alhcsl6836mvyv")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.10)))
