...
(define-public linux-libre-6.1-version "6.1.13")
...
(define-public linux-libre-6.1-pristine-source
  (let ((version linux-libre-6.1-version)
        (hash (base32 "0rvss7g77kp1hldhwrpfc7ck50rd0cjfcxj1bshps1xhyhci7128")))
...
(define-public linux-libre-5.15-version "5.15.95")
...
(define-public linux-libre-5.15-pristine-source
  (let ((version linux-libre-5.15-version)
        (hash (base32 "06s4aqkk26fph8hm15m7cssjrwa5y7cqy9y2znfnf0w8sbqd2wga")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.15)))

(define-public linux-libre-5.10-version "5.10.169")
...
(define-public linux-libre-5.10-pristine-source
  (let ((version linux-libre-5.10-version)
        (hash (base32 "1kxgxdbgymdhf7w416qxv948py0mq8qlhz5ag962322ynmp4yxfr")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.10)))
...
(define-public linux-libre-4.19-version "4.19.273")
...
(define-public linux-libre-4.14-version "4.14.306")
...
(define-public linux-libre-4.14-pristine-source
  (let ((version linux-libre-4.14-version)
        (hash (base32 "17phif2kazp5wykjv7vphjzv8bcanvpv5qq4v3df5nq9gbpypfsq")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.14)))
