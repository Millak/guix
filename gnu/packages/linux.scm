...
(define-public linux-libre-6.1-version "6.1.11")
...
(define-public linux-libre-6.1-pristine-source
  (let ((version linux-libre-6.1-version)
        (hash (base32 "18gpkaa030g8mgmyprl05h4i8y5rjgyvbh0jcl8waqvq0xh0a6sq")))
...
(define-public linux-libre-5.15-version "5.15.93")
...
(define-public linux-libre-5.15-pristine-source
  (let ((version linux-libre-5.15-version)
        (hash (base32 "1baxkkd572110p95ah1wv0b4i2hfbkf8vyncb08y3w0bd7r29vg7")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.15)))
