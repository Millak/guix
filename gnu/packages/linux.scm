...
(define-public linux-libre-6.3-version "6.3.7")
...
(define deblob-scripts-6.3
  (linux-libre-deblob-scripts
   ...
   (base32 "0829793c0wc27p910q9qp4ixdp11m44l1rvl8403yhscnc3hagga")))
...
(define-public linux-libre-6.1-version "6.1.33")
...
(define-public linux-libre-5.10-version "5.10.183")
...
(define-public linux-libre-5.10-pristine-source
  (let ((version linux-libre-5.10-version)
        (hash (base32 "06b1nlwaqs7g3323zxp1bxfilqpbj700x591vqa9dx6a6p39g520")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.10)))
...
(define-public linux-libre-4.19-version "4.19.285")
...
(define-public linux-libre-4.19-pristine-source
  (let ((version linux-libre-4.19-version)
        (hash (base32 "05nwivdk4w939vrrbn5p2yai1rz7kxqa4bl5f3n6d867b59pg8da")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.19)))

(define-public linux-libre-4.14-version "4.14.317")
