...
(define-public linux-libre-5.15-version "5.15.24")
...
(define-public linux-libre-5.10-version "5.10.101")
...
(define-public linux-libre-5.4-version "5.4.180")
...
(define-public linux-libre-5.4-pristine-source
  (let ((version linux-libre-5.4-version)
        (hash (base32 "07ckmgcqpr39bzpp8v60b2vkb03p8931k7sl3ywg6f00lvcbaf8n")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-5.4)))

(define-public linux-libre-4.19-version "4.19.230")
...
(define-public linux-libre-4.19-pristine-source
  (let ((version linux-libre-4.19-version)
        (hash (base32 "107sqv4izdnazscwhyam88vbinsvnd33z8agn4awc42hkqh9l20p")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.19)))

(define-public linux-libre-4.14-version "4.14.267")
...
(define-public linux-libre-4.9-version "4.9.302")
...
(define-public linux-libre-4.9-pristine-source
  (let ((version linux-libre-4.9-version)
        (hash (base32 "0difn0vjz4hz9vl5lklawqy19ccb5gz5p5r1cyckschf0l2nyifm")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.9)))
