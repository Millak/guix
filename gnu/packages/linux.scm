...
(define-public linux-libre-6.17-version "6.17.9")
...
(define-public linux-libre-6.17-pristine-source
  (let ((version linux-libre-6.17-version)
        (hash (base32 "01lfiw67jm853jr3wddvv0hl6lljscg2ils4ips9sl1wjlxq023d")))
...
(define-public linux-libre-6.12-version "6.12.59")
...
(define-public linux-libre-6.12-pristine-source
  (let ((version linux-libre-6.12-version)
        (hash (base32 "1gjqr91qysbzx55ic8101l8vsfb4q09bph8m4q1fq3pi4xrwvlm1")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.12)))

(define-public linux-libre-6.6-version "6.6.117")
...
(define-public linux-libre-6.6-pristine-source
  (let ((version linux-libre-6.6-version)
        (hash (base32 "1la3if0n4pv8lii4ggh4c69a61aga66bdl7x1jkvvz92j83k2fv4")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.6)))
