...
(define (bootstrap-executable-url program system)
  ...
  (string-append
   ...
   "http://brielmaier.net/guix/bootstrap/"
   system "/" program
...
(define (bootstrap-guile-hash system)
  ...
  (match system
    ...
    ("powerpc64le-linux"
     (base32 "03cykvqc01was0sb393v537cgzmji8hyqx1vy63wkzv30kz1ayqd"))))
                          ...
                          (origin
                           ...
                           (sha256
                            (match system
                              ...
                              ("powerpc64le-linux"
                               (base32
                                "031w6jblaywri6rfw5b27wc1ywig47mqpn7981wpjkx8dk3kb0c9"))))))
                          ...
                          (origin
                           ...
                           (sha256
                            (match system
                              ...
                              ("powerpc64le-linux"
                               (base32
                                "0h9skwhpka7n5698xfpqhygn9gll6s18rnay7j8nh0a68lxsvs5b"))))))
                    ...
                    (origin
                     ...
                     (sha256
                      (match (%current-system)
                        ...
                        ("powerpc64le-linux"
                         (base32
                          "079dz2p4j8rfvcpig6smq0kwikilv2a3b9paikszws982149gvbp")))))))))
                    ...
                    (origin
                      ...
                      (sha256
                       (match (%current-system)
                         ...
                         ("powerpc64le-linux"
                          (base32
                           "08v69kw3q5vbc6zlk1g5vvadvad95v2yvp0819f1423sjr73wl9g")))))))))
    (native-search-paths
