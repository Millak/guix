...
(define-public homebank
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1iy4dddcmpjgndpvjq2nbl0nwpdhds6pjrz2z345a8d2gvhazgph"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0zcgxjs2agd6asl4rv2drwb82l92474smp3fdcpypp2772j23gnf"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public beancount-language-server
  (package
    ...
    (synopsis "Language server for the Beancount accounting application")
    (description
     "This package provides a language server for the Beancount double-entry
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0zwrw8blhwyfilggvycv88qmn8ysgdahhriqvzcs71sc6ssiwnhj"))))
    (build-system gnu-build-system)
    (arguments
     `(#:configure-flags
       ,#~(list "--disable-static"
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1x4rw991y87kh90b5fq6zzj9zhi32jr56xv1bm4dppcz724jx7xp"))))
    (build-system pyproject-build-system)
    (arguments
     (list
