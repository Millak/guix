...
(define-public ggml
  (package
    (name "ggml")
    (version "0.9.8")                   ;sync with llama.cpp and whisper.cpp
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "149j80i60l7c4zaa6ji48yfr9q6cbjn2m8l2wwcx2c0bh346b02x"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:configure-flags
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0lp8bg4kblm3h2b0cqmin42gkqd5wgsmy6ng4shkywq83cb47f35"))))
    (build-system gnu-build-system)
    (arguments
     (list
      #:tests? #f                       ;no tests
