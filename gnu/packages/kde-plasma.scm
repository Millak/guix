...
(define-public bluedevil
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1dndb6zcsk2qsqj4cpnw6z6zvyj4nrnd076mgxl4rvs20k6lpcyj"))))
    (build-system qt-build-system)
...
(define-public breeze-gtk
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "10fjaimhk15dq2l213hj7z67m6q837b2g18iwqa8q5mviw5lxnim"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kde-gtk-config
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0nl8v7chgc219aw0xa2g5m177l2iqdvm8aqhik4nkfgws5g4lsv6"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kdecoration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06k8acdj29llp3gavijjfgs9m3l7n5vyd3fpnqks81sg6z37n8fw"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs
...
(define-public kde-cli-tools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0y92l4km0d2s1ayg4lkwizh721lzgn657z718x2ma5b3iqy5sfq8"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
...
(define-public kdeplasma-addons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jzmhhhjxl8fc2y1p7nm7cq8dfc53nx8mw3w06aqp6aqfac9pdij"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
...
(define-public kglobalacceld
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0xh1vifpdjsgipndvzzsxdz02da3ylq6hbcyv4a1w47dazcm4gka"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:phases
                     #~(modify-phases %standard-phases
...
(define-public kinfocenter
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "075qslmnxzgz07m5lrbbpnb5cj1pmb79mmbz877i8r409jgqyysn"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kmenuedit
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "17q23zyx46xjafsyvyvm2rf0i6fli000i0xvw04x1j1dbqhdh1a5"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f))
    (native-inputs (list extra-cmake-modules kdoctools))
...
(define-public knighttime
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "18rnlxgsjhrvkyn85m022m6vam7bbfb52hrg5fxndy2rf2xk0951"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
...
(define-public ksshaskpass
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jvbxhamibl3d4r5nlpn1si4xxw8045q6nn37nsidfa2cjgp47hr"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f))
...
(define-public layer-shell-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "049cmgz8i7ym1xdkakcvm7ak1y2yb58qnc6q1hrbqz4bbgjzwi38"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f))
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/plasma/" version "/"
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "1yb1r2786fi0x304i4ky5ygxkba57vcxgvrl1a00djdhv1ng0nsr"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public ocean-sound-theme
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0b514iba9fbl3rkkf6kn448ga65671wc6idxsf0w6g8ak74rqqnf"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs (list extra-cmake-modules))
    (inputs (list qtbase))
...
(define-public xdg-desktop-portal-kde
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0afdz1ch70m83sy1rf0whdjyfhjp4bxi1w45c8i9mcq5ga3g31x2"))))
    (build-system qt-build-system)
    (arguments (list
...
(define-public plasma-activities
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04d5wmpd5328l3wa65dnn0b98fzrq01p14yfv0b04iy7ph79irag"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public plasma-activities-stats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "041a466iz29b8gjk3r1g8wa14chkd6279zaj89596gyk81l1na3z"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
     (list extra-cmake-modules))
...
(define-public plasma-browser-integration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1vnr3dnfswz1mll3c5c91887clf4iafv31pzpcpvp8pgpv6a5sc8"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules pkg-config))
...
(define-public plasma-desktop
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1is6050gydb7jsq5hwx2x881y5bgfl5zmc6jbi22wnsp64jz2rr3"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules
                         dbus
                         kdoctools
...
(define-public plasma-disks
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0xvbqhfni5r2rc7s4m3qsx9a85k0j1gcj7qvw0jwkzfipzmn6f6z"))))
    (build-system qt-build-system)
    (arguments (list
                #:qtbase qtbase
                #:phases
...
(define-public plasma-firewall
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0p50ypr4drcxwrx783harkk37swk7lv9pp0gxs1jss6s5c8vck75"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs (list extra-cmake-modules))
    (inputs (list iproute
...
(define-public plasma-integration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1ig33m92i2iq18djn75mj4lfz8nxrfqm3jnwpkws2wh7vidghnmd"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:configure-flags #~(list "-DBUILD_QT5=OFF")
...
(define-public plasma-nano
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1ppg3svbj2ykb63z2s58bl9s56f7ffa7595xbxrxn0dc7ahg5isl"))))
    (build-system cmake-build-system)
    (native-inputs (list extra-cmake-modules pkg-config qttools))
    (inputs (list qtbase
                  qtdeclarative
...
(define-public plasma-workspace
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1m0zad6rcc8wjjpcpi1nxzz8h99d4hwxj7yfdm0jg7nxpcxpdc19"))))
    (build-system qt-build-system)
...
(define-public polkit-kde-agent
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0jix36pdq9q5pwx91q6bbzzrv0rx7l5yj6m0ww2ymh2lbdz84pg7"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f))
    (native-inputs (list extra-cmake-modules))
...
(define-public powerdevil
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1r5zbvizg6r889zspaswb7jmbs4imlrnrn0xay3dz76z0m6w2rqz"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules qttools pkg-config))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1fljfn0lrnbhwfar07777f8gm6nvzrykbfzpfrk36l0ir2w2m50x"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f)) ;no tests
...
(define-public wacomtablet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1lk7nk0n1x1i2cn5c4p5mywhxm8v91jnkkcdbczqrs443579a35y"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:test-exclude
