...
(define %icecat-140.13.0-base-version "140.13.0")
(define %icecat-140.13.0-version (string-append %icecat-140.13.0-base-version "-gnu1"))
(define icecat-140.13.0-source
  (let* ((major-version (first  (string-split %icecat-140.13.0-base-version #\.)))
         (minor-version (second (string-split %icecat-140.13.0-base-version #\.)))
         (sub-version   (third  (string-split %icecat-140.13.0-base-version #\.)))

         (upstream-firefox-version (string-append %icecat-140.13.0-base-version "esr"))
         (upstream-firefox-source
          (origin
            (method url-fetch)
            (uri (string-append
            ...
            (sha256
             (base32
              "00adf648nrhzngb4ssx31l17bh4zym491mx7b8ca3g9ajk39sfzm"))))

         (gnuzilla-commit "715ab58c4226572511cad0496908b64124f6729d")
         (gnuzilla-source
          (origin
            (method git-fetch)
            (uri (git-reference
            ...
            (sha256
             (base32
              "19ypzm9fm43b3h4gzhpriz5jax07lglibab1ybnf3x9j9by3v4mc"))))
    ...
    (origin
      (method computed-origin-method)
      (file-name (string-append "icecat-" %icecat-140.13.0-version ".tar.zst"))
      (sha256 #f)
      (uri
       (delay
        (with-imported-modules '((guix build utils))
          #~(begin
              (use-modules (guix build utils))
              (let ((firefox-dir
                     (string-append "firefox-" #$%icecat-140.13.0-base-version))
                    (icecat-dir
                     (string-append "icecat-" #$%icecat-140.13.0-version)))
...
(define %icedove-build-id "20260721000000") ;must be of the form YYYYMMDDhhmmss
...
;;; the icedove version.
(define %icedove-version "140.13.0")
...
(define thunderbird-comm-source
  (origin
    ...
    (uri (hg-reference
          ...
          (changeset "faf78db7dfb184002adc6b859c8ad395ff216239")))
    (file-name (string-append "thunderbird-" %icedove-version "-checkout"))
    (sha256
     (base32
      "0rxp08v20q63ckzkjpyzki00z3svqhy83s1gx4x2ywzlhzyyvxkc"))
