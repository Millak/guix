...
(define-public guile-safsaf
  (let ((commit "2be53482c396df550863ab6d407327325e003791")
        (revision "1"))
    (package
    (name "guile-safsaf")
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0dx4lnxlch8wixkqpbf1br2v0830w9x0f378mvhx1g3hqcqkr17h"))
              (file-name (git-file-name name version))))
    (build-system gnu-build-system)
    (native-inputs
     (list pkg-config
...
(define-public guix-data-service
  (let ((commit "4ba0a4838b46829df03e1b072879677a153806da")
        (revision "78"))
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "1niajnldgc6g5ph2b07688jlfiy9i94x6p08nizvns4wqwzcgc30"))))
      (build-system gnu-build-system)
      (arguments
       (list
        #:modules '((guix build utils)
