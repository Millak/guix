  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "067vyh4hmymkhk21ppqx09avgqbfxka5xfyq9i8sw9vpmfpj57yc"))))
    (build-system go-build-system)
    (arguments
     (list
      #:go go-1.26
...
(define-public guile-safsaf
  (let ((commit "8b354103ee2b7182bebcc944c36741469ddf4fb8")
        (revision "1"))
    (package
    (name "guile-safsaf")
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0pw09cw0d52xhjbqj76c4bl44qnmw53ppg6hnhkliv9ssbrlccar"))
              (file-name (git-file-name name version))))
    (build-system gnu-build-system)
    (native-inputs
     (list pkg-config
...
(define-public guix-data-service
  (let ((commit "029880e5633789ce96ec363a94d98aed6451430f")
        (revision "79"))
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "1h7k30k2hrql2r5kg1qhsq5haxzs2qzzkc195aidigr2vnj7xkm0"))))
      (build-system gnu-build-system)
      (arguments
       (list
        #:modules '((guix build utils)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1l71qyhmhfwyb4zqprkg4585wsbarnryhbk6rh5idh835yj17d1b"))))
    (build-system pyproject-build-system)
    (arguments
     (list
      #:test-flags
...
(define-public nghttp2-for-node-bootstrap
  (package
    (inherit nghttp2)
    (version "1.58.0")
    (source
...
(define-public kiwix-lib
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "17chyyrbj239fd4iwcnb01yyk7p1zyxbn7fw1a9pr7r05ngsax1s"))
              (file-name (git-file-name name version))))
    (build-system meson-build-system)
    (arguments
     `(#:phases
